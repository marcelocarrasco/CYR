...
WITH  OBJ as (
                SELECT  CANTIDAD,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',1,INSTR('&4',',',1,1)-1),'999999.999'))) AV_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',1,INSTR('&4',',',1,1)-1),'999999.999'))) AV_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,1)+1,INSTR('&4',',',1,2)-INSTR('&4',',',1,1)-1),'999999.999'))) LD_LOW ,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,1)+1,INSTR('&4',',',1,2)-INSTR('&4',',',1,1)-1),'999999.999'))) LD_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,2)+1,INSTR('&4',',',1,3)-INSTR('&4',',',1,2)-1),'999999.999'))) LT_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,2)+1,INSTR('&4',',',1,3)-INSTR('&4',',',1,2)-1),'999999.999'))) LT_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,3)+1,INSTR('&4',',',1,4)-INSTR('&4',',',1,3)-1),'999999.999'))) PSB_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,3)+1,INSTR('&4',',',1,4)-INSTR('&4',',',1,3)-1),'999999.999'))) PSB_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,4)+1,INSTR('&4',',',1,5)-INSTR('&4',',',1,4)-1),'999999.999'))) QDL_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,4)+1,INSTR('&4',',',1,5)-INSTR('&4',',',1,4)-1),'999999.999'))) QDL_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,5)+1,INSTR('&4',',',1,6)-INSTR('&4',',',1,5)-1),'999999.999'))) QUL_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,5)+1,INSTR('&4',',',1,6)-INSTR('&4',',',1,5)-1),'999999.999'))) QUL_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,6)+1,INSTR('&4',',',1,7)-INSTR('&4',',',1,6)-1),'999999.999'))) RC_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,6)+1,INSTR('&4',',',1,7)-INSTR('&4',',',1,6)-1),'999999.999'))) RC_HI,
                        ROUND(CANTIDAD -(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,7)+1),'999999.999'))) EST_LOW,
                        ROUND(CANTIDAD +(CANTIDAD* TO_NUMBER(SUBSTR('&4',INSTR('&4',',',1,7)+1),'999999.999'))) EST_HI
                FROM  (
